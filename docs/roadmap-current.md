...
- External API v1 companion migration foundation: vendor the frozen protobuf
  contract, add codegen, and build the pure codec/handshake/report layer beside
  the legacy `9876` path.
  ...
  - Outcome: v1 protocol foundation is unit-tested while legacy service,
    settings, SOCKS5, and theme transfer behavior remain available.
